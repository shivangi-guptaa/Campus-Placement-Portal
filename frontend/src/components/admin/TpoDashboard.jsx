...
import { Building2, Briefcase, Users, TrendingUp, Award, UserCheck, Mail, Phone } from "lucide-react";
    ...
    return (
      <div className="bg-white dark:bg-gray-900 min-h-screen text-gray-900 dark:text-white">
        ...
        <div className="max-w-7xl mx-auto p-8 text-center text-gray-500 font-medium">
          Loading Placement Statistics & Candidate Directory...
        </div>
      </div>
    );
  }
    ...
    <div className="min-h-screen bg-gray-50 dark:bg-gray-950 pb-12 transition-colors flex flex-col justify-between">
      <div>
        ...
        <div className="max-w-7xl mx-auto px-4 mt-8">
          <div className="flex items-center justify-between mb-6">
            <div>
              ...
              <p className="text-sm text-gray-500 dark:text-gray-400 mt-1">
                Real-time Placement Drive Metrics, Registered Candidates & Analytics
              </p>
            </div>
          ...
          <div className="bg-white dark:bg-gray-900 border dark:border-gray-800 rounded-2xl p-6 shadow-sm mb-8">
            <div className="flex items-center justify-between mb-4">
              <h3 className="text-lg font-bold text-gray-900 dark:text-white flex items-center gap-2">
                <UserCheck className="w-5 h-5 text-purple-600 dark:text-purple-400" /> Registered Students & Candidates Roster
              </h3>
              <span className="text-xs font-bold bg-gray-100 dark:bg-gray-800 text-gray-700 dark:text-gray-300 px-3 py-1 rounded-full">
                {registeredUsers?.length || 0} Accounts Total
              </span>
            </div>
                  ...
                  {!registeredUsers || registeredUsers.length === 0 ? (
                    <tr>
                      <td colSpan={7} className="p-4 text-center text-gray-500">
                        No registered candidate accounts found.
                      </td>
                    </tr>
                  ) : (
                    registeredUsers.map((usr) => (
                      <tr key={usr.id} className="hover:bg-gray-50 dark:hover:bg-gray-800/40">
                        ...
                        <td className="p-3 text-gray-700 dark:text-gray-300 flex items-center gap-1.5">
                          <Mail className="w-3.5 h-3.5 text-purple-500" /> {usr.email}
                        </td>
                        ...
                        <td className="p-3 text-gray-500 dark:text-gray-400 text-xs">
                          {usr.createdAt ? String(usr.createdAt).split("T")[0] : "Recently"}
                        </td>
                      </tr>
                    ))
                  )}
          ...
          {/* Top Company Package Offers Table */}
          <div className="bg-white dark:bg-gray-900 border dark:border-gray-800 rounded-xl p-6 shadow-sm">
            <h3 className="text-lg font-bold text-gray-900 dark:text-white mb-4">Top Company Package Offers</h3>
            <div className="overflow-x-auto">
              <table className="w-full text-left text-sm">
                <thead className="bg-gray-50 dark:bg-gray-800/80 border-b dark:border-gray-800 text-xs uppercase font-bold text-gray-500 dark:text-gray-400">
                  <tr>
